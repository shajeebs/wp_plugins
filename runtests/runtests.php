...
function addAdminRunTestPage() {
  add_menu_page('Run Tests', 'Run Tests', 'manage_options' ,__FILE__, 'runTestsAdminPage', 'dashicons-code-standards');
}

function runTestsAdminPage() {
  global $wpdb;?>
  <div class="wrap" id="runTests">
    <h2>Run Tests</h2>
    ...
    <div class="rowLayout">		
      <div class="columnLayout" style="border:1px solid blue;  background-color:#74cfd27a;">
        ...
        <div id="vueCode" style="border:1px solid brown;  background-color:#80f3a1;">
          <b><u>Test Vue Code</u></b><br>
          <?php  TestVueCode(); ?>
        </div>
      </div>
...
function TestVueCode(){
  // Use shortcode in a PHP file (outside the post editor).
  // echo plugin_dir_url( __FILE__ )."<br>";
  // echo do_shortcode('');

  // In case there is opening and closing shortcode.
  //echo do_shortcode('[fg-wpvue]');
  echo do_shortcode('[students]');
}
