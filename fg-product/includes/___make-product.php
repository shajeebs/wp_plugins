...
function fgpt_makeProductFormPage_handler()
{
    ...
    add_meta_box('makeProductForm_metaBox', __('Makes row materials into finished products.', 'fgpt'), 'fgpt_MakeProductForm_Handler', 'product', 'normal', 'default');
    ?>
<div class="wrap">
...
function fgpt_MakeProductForm_Handler($item)
{ 
